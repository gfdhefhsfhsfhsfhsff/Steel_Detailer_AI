...
#### [](#chamfer)[Chamfer](DesignData.SDS2.Model.Chamfer.html)

A class representing a chamfer segment

#### [](#chamferedge)[ChamferEdge](DesignData.SDS2.Model.ChamferEdge.html)

A material operation for chamfering a list of material edges

#### [](#chamferlist)[ChamferList](DesignData.SDS2.Model.ChamferList.html)

#### [](#chamferlist-chamferlistenumerator)[ChamferList.ChamferListEnumerator](DesignData.SDS2.Model.ChamferList.ChamferListEnumerator.html)

#### [](#chamferpointtopoint)[ChamferPointToPoint](DesignData.SDS2.Model.ChamferPointToPoint.html)
...
#### [](#cutlayout)[CutLayout](DesignData.SDS2.Model.CutLayout.html)

Cut layout material operation

#### [](#cutonplane)[CutOnPlane](DesignData.SDS2.Model.CutOnPlane.html)
...
#### [](#fitcope)[FitCope](DesignData.SDS2.Model.FitCope.html)

A fit cope material operation

#### [](#fitexact)[FitExact](DesignData.SDS2.Model.FitExact.html)

A fit exact material operation

#### [](#fitmitre)[FitMitre](DesignData.SDS2.Model.FitMitre.html)

Fit mitre material operation

#### [](#fitnotch)[FitNotch](DesignData.SDS2.Model.FitNotch.html)

A fit notch material operation
...
#### [](#materialcutter)[MaterialCutter](DesignData.SDS2.Model.MaterialCutter.html)

Snapshot of material used to cut another material

#### [](#materialcutterlist)[MaterialCutterList](DesignData.SDS2.Model.MaterialCutterList.html)

#### [](#materialcutterlist-materialcutterlistenumerator)[MaterialCutterList.MaterialCutterListEnumerator](DesignData.SDS2.Model.MaterialCutterList.MaterialCutterListEnumerator.html)

#### [](#materialfit)[MaterialFit](DesignData.SDS2.Model.MaterialFit.html)
...
#### [](#materialmitrer)[MaterialMitrer](DesignData.SDS2.Model.MaterialMitrer.html)

Snapshot of material used to mitre another material

#### [](#materialmitrerlist)[MaterialMitrerList](DesignData.SDS2.Model.MaterialMitrerList.html)

#### [](#materialmitrerlist-materialmitrerlistenumerator)[MaterialMitrerList.MaterialMitrerListEnumerator](DesignData.SDS2.Model.MaterialMitrerList.MaterialMitrerListEnumerator.html)

#### [](#materialoperation)[MaterialOperation](DesignData.SDS2.Model.MaterialOperation.html)
...
#### [](#materialoperationlist)[MaterialOperationList](DesignData.SDS2.Model.MaterialOperationList.html)

#### [](#materialoperationlist-materialoperationlistenumerator)[MaterialOperationList.MaterialOperationListEnumerator](DesignData.SDS2.Model.MaterialOperationList.MaterialOperationListEnumerator.html)
