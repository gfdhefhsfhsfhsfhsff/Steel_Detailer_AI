...
#### [](#DesignData%5FSDS2%5FModel%5FMaterial%5FIsUserWeight)IsUserWeight

True indicates the weight is user defined

##### Declaration

```
public bool IsUserWeight { get; set; }
```
...
This is toggled on automatically when a weight is assigned through the API. If IsUserWeight is toggled off, the system will set the computed weight during the transaction commit operation
...
In pounds. Assigning a weight will automatically turn on IsUserWeight

##### Exceptions

| Type                                                                           | Condition                                                        |
| ------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [InvalidValueException](DesignData.SDS2.Exceptions.InvalidValueException.html) | InvalidValueException thrown when weigth is less than zero.      |
| [NotLockedException](DesignData.SDS2.Exceptions.NotLockedException.html)       | Thrown when the material is unlocked while setting the property. |
...
#### [](#DesignData%5FSDS2%5FModel%5FMaterial%5FGetOperations)GetOperations()

The list of material operations applied to this material.

##### Declaration

```
public MaterialOperationList GetOperations()
```
