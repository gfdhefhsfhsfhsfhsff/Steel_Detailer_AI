...
2. The key source files live at `d:\sds tooling\`:
...
3. The SDS2 .NET API documentation is at `d:\sds tooling\output\`:
...
// turbo
```powershell
dotnet build "d:\sds tooling\Checker1\Checker1.csproj"
dotnet build "d:\sds tooling\Checker2\Checker2.csproj"
```

5. Run commands:
```powershell
& "d:\sds tooling\Checker1\bin\net48\Checker1.exe"
& "d:\sds tooling\Checker2\bin\net48\Checker2.exe"
```
